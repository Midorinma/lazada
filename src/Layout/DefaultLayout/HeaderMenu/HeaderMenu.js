...
export const CartContent = ({ className }) => {
    return (
        <div className={cx('cart-channel-content')}>
            <Button to={config.routes.lazMall} className={className}>
            ...
            <Button to={config.routes.vouchers} className={className}>
                <div className={cx('box')}>
                    <div className={cx('cart-channel-img')}>
                        <img
                            className={cx('image')}
            ...
            <Button to={config.routes.topUp} className={className}>
                <div className={cx('box')}>
                    <div className={cx('cart-channel-img')}>
                        <img
                            className={cx('image')}
            ...
            <Button to={config.routes.lazGlobal} className={className}>
                <div className={cx('box')}>
                    <div className={cx('cart-channel-img')}>
                        <img
                            className={cx('image')}
